...
#This doesn't work and still needs to be worked on

loan_quotes.each do|rateoutput|
	puts "Your loan amount at " + rateoutput["bank"] + " will be #{pmt(rateoutput["rate"], nper, pv)}."
end